...
@Component
public class DataRepositoryTest extends MsgApplicationTests {
    ...
    public void testFind() {
        List<DataVO> all = dataRepository.findAll();
        for (DataVO dataVO : all) {
    ...
    public void save() {
        for (int i = 0; i < 10; i++) {
            ...
            dataVO.setName(getChineseName());
            dataVO.setAge(reage());
            DataVO save = dataRepository.save(dataVO);
